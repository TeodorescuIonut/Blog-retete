 <!-- Navigation -->
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container nav-container">
        <a class="navbar-brand" href="http://localhost/CursWebNov2017/Proiect%20retete/proiect retete/index.php">Flavours</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="http://localhost/CursWebNov2017/Proiect%20retete/proiect retete/recipe-fish.php">Fish recipes</a>
            </li>
            <li class="nav-item">
